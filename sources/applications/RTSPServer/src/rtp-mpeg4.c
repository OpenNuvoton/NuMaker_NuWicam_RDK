									 ...
									 unsigned char *d, int len)
{
	...
	spook_log(SL_DEBUG, "rtp-mpeg4: vop_time_increment = %d, vop_time_increment_resolution = %d", out->vop_time_increment,
			  out->vop_time_increment_resolution);
