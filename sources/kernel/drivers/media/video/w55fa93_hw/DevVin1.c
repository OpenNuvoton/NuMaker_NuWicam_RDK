	...
	)
{
	...
	else if(eDevType == eDrvVideoIn_2nd_SNR_CCIR601)
	{
		...
		#if defined(CONFIG_SENSOR_GM7150_DEV1) || defined(CONFIG_SENSOR_TVP5150_DEV1)
			//NuWicam board, GPB0 is GPIO Input
	                outp32(REG_GPBFUN, (inp32(REG_GPBFUN) | 0xC));
		#else
			outp32(REG_GPBFUN, (inp32(REG_GPBFUN) | 0xF));
		#endif
